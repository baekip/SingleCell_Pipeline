...
sample.markers <- FindAllMarkers(object = sample.cluster, logfc.threshold = 0.5)
...
###Save RDS file
saveRDS (sample.cluster, file = paste(c(output.path,"/Rdata/",sample.id,".Cluster.Rda"), collapse=""))
